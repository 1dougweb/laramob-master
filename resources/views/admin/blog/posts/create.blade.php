                    ...
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
                        <div class="md:col-span-3 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="content" name="content" rows="10" class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm">{{ old('content') }}</textarea>
                            ...
                            <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <x-text-input id="seo_title" name="seo_title" type="text" class="mt-1 block w-full" :value="old('seo_title')" />
                                    ...
                                    <div>
                                        ...
                                        <textarea id="meta_description" name="meta_description" rows="3" class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm" maxlength="160">{{ old('meta_description') }}</textarea>
                ...
                <div class="mt-8">
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="text-xl text-blue-800 font-medium" id="preview-title">Título do seu post aparecerá aqui</div>
                            <div class="text-sm text-gray-600" id="preview-description">A meta descrição do seu post aparecerá aqui. Esta é uma prévia de como seu post será exibido nos resultados de busca do Google.</div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    document.getElementById('title').addEventListener('input', function() {
        document.getElementById('preview-title').textContent = this.value || 'Título do Post';
    });

    // Update preview description
    document.getElementById('meta_description').addEventListener('input', function() {
        document.getElementById('preview-description').textContent = this.value || 'Meta descrição do post que aparecerá nos resultados de busca...';
    });
