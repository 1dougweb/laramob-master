        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.people.update', $person) }}" method="POST" class="space-y-8" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                                    <div class="flex items-center space-x-2 p-3 rounded-lg border-2 {{ (old('type') ?? $person->type) == 'employee' ? 'border-blue-500 bg-blue-50' : 'border-gray-200' }}">
                                        <input type="radio" id="type_employee" name="type" value="employee" {{ (old('type') ?? $person->type) == 'employee' ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500">
                                        <label for="type_employee" class="text-sm font-medium text-gray-700">Funcionário</label>
                                    </div>
                                    <div class="flex items-center space-x-2 p-3 rounded-lg border-2 {{ (old('type') ?? $person->type) == 'broker' ? 'border-blue-500 bg-blue-50' : 'border-gray-200' }}">
                                        <input type="radio" id="type_broker" name="type" value="broker" {{ (old('type') ?? $person->type) == 'broker' ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500">
                                        <label for="type_broker" class="text-sm font-medium text-gray-700">Corretor</label>
                                    </div>
                                    <div class="flex items-center space-x-2 p-3 rounded-lg border-2 {{ (old('type') ?? $person->type) == 'owner' ? 'border-blue-500 bg-blue-50' : 'border-gray-200' }}">
                                        <input type="radio" id="type_owner" name="type" value="owner" {{ (old('type') ?? $person->type) == 'owner' ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500">
                                        <label for="type_owner" class="text-sm font-medium text-gray-700">Vendedor/Locador</label>
                                    </div>
                                    <div class="flex items-center space-x-2 p-3 rounded-lg border-2 {{ (old('type') ?? $person->type) == 'client' ? 'border-blue-500 bg-blue-50' : 'border-gray-200' }}">
                                        <input type="radio" id="type_client" name="type" value="client" {{ (old('type') ?? $person->type) == 'client' ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500">
                                        <label for="type_client" class="text-sm font-medium text-gray-700">Comprador</label>
                                    </div>
                                    <div class="flex items-center space-x-2 p-3 rounded-lg border-2 {{ (old('type') ?? $person->type) == 'tenant' ? 'border-blue-500 bg-blue-50' : 'border-gray-200' }}">
                                        <input type="radio" id="type_tenant" name="type" value="tenant" {{ (old('type') ?? $person->type) == 'tenant' ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500">
                            ...
                            <div id="all_types_fields" class="mt-6">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="name" id="name" value="{{ old('name') ?? $person->name }}" required class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>

                                    <!-- E-mail -->
                                    <div>
                                        <label for="email" class="block text-sm font-medium text-gray-700 mb-1">E-mail *</label>
                                        <input type="email" name="email" id="email" value="{{ old('email') ?? $person->email }}" required class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                                    ...
                                    <div>
                                        ...
                                        <select name="document_type" id="document_type" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            <option value="cpf" {{ (old('document_type') ?? $person->document_type) == 'cpf' ? 'selected' : '' }}>CPF</option>
                                            <option value="cnpj" {{ (old('document_type') ?? $person->document_type) == 'cnpj' ? 'selected' : '' }}>CNPJ</option>
                                        </select>
                                    </div>

                                    <!-- Documento -->
                                    <div>
                                        <label id="document_label" for="document" class="block text-sm font-medium text-gray-700 mb-1">{{ (old('document_type') ?? $person->document_type) == 'cpf' ? 'CPF' : 'CNPJ' }}</label>
                                        <input type="text" name="document" id="document" value="{{ old('document') ?? $person->document }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="phone" id="phone" value="{{ old('phone') ?? $person->phone }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md phone-mask">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <div class="relative flex items-stretch flex-grow">
                                                ...
                                                <input type="text" name="mobile" id="mobile" value="{{ old('mobile') ?? $person->mobile }}" class="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md phone-mask" placeholder="(00) 00000-0000">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="nationality" id="nationality" value="{{ old('nationality') ?? $person->nationality ?? 'Brasileira' }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    
                                    <div>
                                        <label for="birth_date" class="block text-sm font-medium text-gray-700 mb-1">Data de Nascimento</label>
                                        <input type="date" name="birth_date" id="birth_date" value="{{ old('birth_date') ?? ($person->birth_date ? $person->birth_date->format('Y-m-d') : '') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                                    <div>
                                        ...
                                        <select name="marital_status" id="marital_status" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            ...
                                            <option value="solteiro" {{ (old('marital_status') ?? $person->marital_status) == 'solteiro' ? 'selected' : '' }}>Solteiro(a)</option>
                                            <option value="casado" {{ (old('marital_status') ?? $person->marital_status) == 'casado' ? 'selected' : '' }}>Casado(a)</option>
                                            <option value="divorciado" {{ (old('marital_status') ?? $person->marital_status) == 'divorciado' ? 'selected' : '' }}>Divorciado(a)</option>
                                            <option value="viuvo" {{ (old('marital_status') ?? $person->marital_status) == 'viuvo' ? 'selected' : '' }}>Viúvo(a)</option>
                                            <option value="separado" {{ (old('marital_status') ?? $person->marital_status) == 'separado' ? 'selected' : '' }}>Separado(a)</option>
                                            <option value="uniao_estavel" {{ (old('marital_status') ?? $person->marital_status) == 'uniao_estavel' ? 'selected' : '' }}>União Estável</option>
                                        </select>
                                    </div>
                                    
                                    <div>
                                        <label for="profession" class="block text-sm font-medium text-gray-700 mb-1">Profissão</label>
                                        <input type="text" name="profession" id="profession" value="{{ old('profession') ?? $person->profession }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                </div>
                                ...
                                <div class="mt-6">
                                    ...
                                    <div class="mt-1 flex items-center">
                                        @if($person->photo)
                                            <img src="{{ Storage::url($person->photo) }}" alt="{{ $person->name }}" class="h-16 w-16 rounded-full object-cover">
                                            <input type="hidden" name="current_photo" value="{{ $person->photo }}">
                                        @else
                                    ...
                                    @if($person->photo)
                                        <div class="mt-2">
                                            <label class="inline-flex items-center text-sm text-gray-700">
                                                <input type="checkbox" name="remove_photo" id="remove_photo" value="1" class="rounded border-gray-300 text-red-600 shadow-sm focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50">
                                ...
                                <div class="mt-6">
                                    ...
                                    <div class="mt-2">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="is_active" id="is_active" value="1" {{ (old('is_active') ?? $person->is_active) ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <input type="number" step="0.01" min="0" max="100" name="commission_rate" id="commission_rate" value="{{ old('commission_rate') ?? $person->commission_rate }}" 
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="creci" id="creci" value="{{ old('creci') ?? $person->creci }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="client_tenant_specific_fields" class="mt-6 hidden border-t pt-6">
                                ...
                                <div>
                                    ...
                                    <select name="broker_id" id="broker_id" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        ...
                                        @foreach(\App\Models\Person::where('type', 'broker')->where('is_active', true)->orderBy('name')->get() as $broker)
                                            <option value="{{ $broker->id }}" {{ (old('broker_id') ?? $person->broker_id) == $broker->id ? 'selected' : '' }}>
                                                {{ $broker->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mt-4">
                                    ...
                                    <textarea name="preferences" id="preferences" rows="3" 
                                        ...
                                        placeholder="Ex: Apartamento de 2 quartos, região central, até R$ 300.000">{{ old('preferences') ?? $person->preferences }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 border-t pt-6">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name') ?? $person->bank_name }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>

                                    <!-- Agência -->
                                    <div>
                                        <label for="bank_agency" class="block text-sm font-medium text-gray-700 mb-1">Agência</label>
                                        <input type="text" name="bank_agency" id="bank_agency" value="{{ old('bank_agency') ?? $person->bank_agency }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md agency-mask">
                                    </div>

                                    <!-- Conta -->
                                    <div>
                                        <label for="bank_account" class="block text-sm font-medium text-gray-700 mb-1">Conta</label>
                                        <input type="text" name="bank_account" id="bank_account" value="{{ old('bank_account') ?? $person->bank_account }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md account-mask">
                                    </div>
                                </div>
                                ...
                                <div class="mt-6">
                                    ...
                                    <input type="text" name="pix_key" id="pix_key" value="{{ old('pix_key') ?? $person->pix_key }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="mt-6 border-t pt-6">
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="address" id="address" rows="3" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('address') ?? $person->address }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 border-t pt-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="notes" id="notes" rows="4" maxlength="500" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('notes') ?? $person->notes }}</textarea>
